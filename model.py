...
# sol = minimize(model_opt, budget, method='SLSQP', bounds=bnds, constraints=con1, args=(state_0))
# print(sol)

# sol = minimize(model_opt, budget, method='COBYLA', constraints=con1, args=(state_0))
# print(sol)
# Output: 6646.813621390341
